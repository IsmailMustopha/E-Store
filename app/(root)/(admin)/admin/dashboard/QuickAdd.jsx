...
import { ADMIN_CATEGORY_ADD, ADMIN_COUPON_VARIANT_ADD, ADMIN_MEDIA_SHOW, ADMIN_PRODUCT_ADD } from "@/app/routes/AdminPanelRoute";
...
const QuickAdd = () => {
  return (
    <div className="grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5 mt-10">
      ...
      <Link href={ADMIN_COUPON_VARIANT_ADD}>
