...
const breadcrumbData = [
  ...
  { href: ADMIN_COUPON_VARIANT_SHOW, label: "Product" },
];
...
const ShowCoupon = () => {
  ...
  const action = useCallback((row, deleteType, handleDelete) => {
    ...
    actionMenu.push(
      <EditAction key="edit" href={ADMIN_COUPON_VARIANT_EDIT(row.original._id)} />
    );
      ...
      <Card className="py-0 rounded shadow-sm">
        <CardHeader className="pt-3 px-3 border-b [.border-b]:pb-2">
          <div className="flex justify-between items-center">
            ...
            <Button>
              <FilePlus />
              <Link href={ADMIN_COUPON_VARIANT_ADD}>New Coupon</Link>
            </Button>
          </div>
        </CardHeader>
