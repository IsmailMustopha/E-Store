"use client";
import { WEBSITE_CHECKOUT, WEBSITE_PRODUCT_DETAILS, WEBSITE_SHOP } from "@/app/routes/WebsitePanelRoute";
              ...
              <tbody>
                {cart.products.map((product) => (
                  ...
                  >
                    ...
                    <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2">
                      ...
                      <div className="flex justify-center">
                        <div className="flex justify-center items-center md:h-10 h-7 border w-fit rounded-full">
                          <button
                            type="button"
                            className="h-full cursor-pointer w-10 flex justify-center items-center"
                            onClick={() =>
                              dispatch(
                                decreaseQuantity({
                    ...
                    <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                      <span className="md:hidden font-medium cursor-pointer">Remove</span>
                      <button
