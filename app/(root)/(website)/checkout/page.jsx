...
const CheckOut = () => {
  ...
  // const [orderTxRef, setOrderTxRef] = useState("");
...
const handleOnlinePayment = async (formData) => {
  ...
  try {
    ...
    showToast("error", "Could not initialize payment. Try again.");
  } finally {
            ...
            <div className="mt-5">
              <Form {...orderForm}>
                <form
                  ...
                  onSubmit={orderForm.handleSubmit(handleOnlinePayment)}
                >
                  <div className="mb-3">
                    <FormField
                ...
                <table className="w-full">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-end py-2">
                        -{" "}
                        {couponDiscountAmount.toLocaleString("en-NG", {
                          style: "currency",
                          currency: "NGN",
                        })}
                      </td>
