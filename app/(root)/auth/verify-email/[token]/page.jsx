...
import { WEBSITE_HOME } from '@/app/routes/WebsitePanelRoute';
    ...
    {isVerified ? (
      <div>
        <div className="flex justify-center items-center">
          <Image src={verifiedImg.src} height={verifiedImg.height} width={verifiedImg.width} alt='' />
        </div>
      ...
      <div>
  <div className='flex justify-center items-center'>
    <Image src={verificationFailedImg.src} height={verifiedImg.height} width={verifiedImg.width} alt='' className='h-[100px] w-auto' />
  </div>
  <div className='text-center'>
