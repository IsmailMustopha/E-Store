...
export const ADMIN_COUPON_VARIANT_ADD = "/admin/product-coupon/add";
export const ADMIN_COUPON_VARIANT_SHOW = "/admin/product-coupon";
export const ADMIN_COUPON_VARIANT_EDIT = (id) =>
  id ? `/admin/product-coupon/edit/${id}` : "";
