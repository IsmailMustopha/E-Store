...
import { USER_DASHBOARD, WEBSITE_ABOUT, WEBSITE_CONDITION, WEBSITE_HOME, WEBSITE_LOGIN, WEBSITE_POLICY, WEBSITE_REGISTER, WEBSITE_SHOP } from '@/app/routes/WebsitePanelRoute';
      ...
      <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-10 py-10 lg:px-32 px-4">
        ...
        <div>
          ...
          <ul>
            ...
            <li className="mb-2 text-gray-500">
              <Link href={WEBSITE_POLICY}>Privacy Policy</Link>
            </li>
            <li className="mb-2 text-gray-500">
              <Link href={WEBSITE_CONDITION}>Terms & Conditions</Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            <li className="mb-2 text-gray-500 flex gap-2">
              ...
              <span className="text-sm">
                E-Store Complex, Ring Road, Ibadan, Oyo State
              </span>
            </li>
            <li className="mb-2 text-gray-500 flex gap-2">
