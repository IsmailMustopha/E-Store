import { ADMIN_CATEGORY_ADD, ADMIN_CATEGORY_SHOW, ADMIN_COUPON_VARIANT_ADD, ADMIN_COUPON_VARIANT_SHOW, ADMIN_CUSTOMER_SHOW, ADMIN_DASHBOARD, ADMIN_MEDIA_SHOW, ADMIN_ORDER_SHOW, ADMIN_PRODUCT_ADD, ADMIN_PRODUCT_SHOW, ADMIN_PRODUCT_VARIANT_SHOW, ADMIN_REVIEW_SHOW } from "@/app/routes/AdminPanelRoute";
...
const searchData = [
  ...
  },
  {
    ...
    url: ADMIN_COUPON_VARIANT_SHOW,
    keywords: ["discount", "promo", "coupon"],
  },
  {
    label: "Add Coupon",
    description: "Create a new discount coupon",
    url: ADMIN_COUPON_VARIANT_ADD,
